...
import { Sparkles, Castle, Camera, Trophy } from 'lucide-react';
  ...
  return (
    <div className="relative flex flex-col items-center justify-center p-3 sm:p-6 w-full max-w-xl mx-auto my-auto select-none">
      ...
      <div className="relative w-full bg-gradient-to-b from-[#d8f1ff] via-[#b6e4fa] to-[#88d2f7] rounded-[36px] sm:rounded-[44px] p-4 sm:p-7 shadow-[0_20px_50px_rgba(8,30,60,0.5)] border-4 border-white/90 text-center overflow-hidden">
        ...
        <div className="relative z-10 bg-white/45 backdrop-blur-xs p-3 sm:p-4 rounded-3xl border-2 border-white/80 shadow-inner my-2.5 flex flex-col items-center justify-center">
        ...
        {/* Top Action Pills: Stars Counter, Castle Album & Castle Story Buttons */}
        <div className="flex items-center justify-center gap-2 sm:gap-2.5 my-2.5 flex-wrap">
          {/* Stars Counter Pill */}
          <div className="inline-flex items-center gap-1.5 bg-white/85 backdrop-blur-xs px-3 sm:px-3.5 py-1.5 rounded-full shadow-[0_4px_12px_rgba(2,132,199,0.2)] border-2 border-white">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            onClick={onOpenAlbum}
            className="inline-flex items-center gap-1.5 bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-400 hover:brightness-110 text-amber-950 px-3.5 sm:px-4 py-1.5 rounded-full shadow-[0_4px_12px_rgba(245,158,11,0.35)] border-2 border-white font-black text-xs sm:text-sm cursor-pointer"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            onClick={onOpenCastle}
            className="inline-flex items-center gap-1.5 bg-gradient-to-r from-sky-500 to-cyan-500 hover:from-sky-400 hover:to-cyan-400 text-white px-3.5 sm:px-4 py-1.5 rounded-full shadow-[0_4px_12px_rgba(2,132,199,0.35)] border-2 border-white font-black text-xs sm:text-sm cursor-pointer"
          >
        ...
        <div className="flex items-center justify-between bg-white/60 backdrop-blur-xs px-4 sm:px-5 py-2 rounded-2xl mb-3 w-full border-2 border-white/80 shadow-inner">
        ...
        <div className="flex flex-col space-y-2 sm:space-y-2.5 w-full">
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-sky-100 via-white to-sky-100 hover:from-white hover:to-sky-50 text-sky-900 py-2.5 sm:py-3.5 px-4 sm:px-5 rounded-2xl sm:rounded-3xl shadow-[0_6px_16px_rgba(2,132,199,0.2)] border-3 border-white border-b-5 active:border-b-3 transition-all flex flex-col items-center justify-center cursor-pointer"
          >
          ...
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-purple-100 via-white to-sky-100 hover:from-white hover:to-purple-50 text-purple-950 py-2.5 sm:py-3.5 px-4 sm:px-5 rounded-2xl sm:rounded-3xl shadow-[0_6px_16px_rgba(168,85,247,0.25)] border-3 border-white border-b-5 active:border-b-3 transition-all flex flex-col items-center justify-center relative overflow-hidden cursor-pointer"
          >
            <div className="flex items-center gap-2">
          ...
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-cyan-100 via-white to-sky-100 hover:from-white hover:to-cyan-50 text-cyan-950 py-2.5 sm:py-3.5 px-4 sm:px-5 rounded-2xl sm:rounded-3xl shadow-[0_6px_16px_rgba(6,182,212,0.2)] border-3 border-white border-b-5 active:border-b-3 transition-all flex flex-col items-center justify-center cursor-pointer"
          >
            <div className="flex items-center gap-2">
